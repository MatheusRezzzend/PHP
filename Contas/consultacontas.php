...
<body>
    <fieldset>
        <form method="post">
            <p>
                <strog>Consultar conta por campo especifico:</strong>
            </p>
