    ...
    <div id="cadastro">
        <form name="signup" method="post">
            <table id="tab_cadastro">
                ...
                <tr>
                    <td>Número Conta:</td>
                    <td><input type="text" name="numconta" required placeholder="Número Conta" id="numconta" class="txt" /></td>
                </tr>
                <tr>
                    <td>Selecionar Agência:</td>
                    <td>
                        <select name="agencianum">
                ...
                <tr>
                    <td>Saldo:</td>
                    <td><input type="number" name="saldo" required placeholder="Saldo" id="saldo" class="txt" /></td>
                </tr>
                <tr>
                    <?php
                ...
                <tr>
                    <td><input type="button" value="Voltar para página inicial" onclick="location.href='http://localhost/bancofinal/Banco/paginainicial.php'">
                </tr>
                </td>
                <tr>
                    <td><input type="submit" value="Criar outra conta">
                </tr>
                </td>
            <?php } ?>
            </tr>
